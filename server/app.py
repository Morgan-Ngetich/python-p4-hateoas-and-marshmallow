...
class NewsletterSchema(ma.SQLAlchemySchema):
    # (Nested class)
    class Meta: # used to provide metadata about the class
        model = Newsletter
        
    title = ma.auto_field()
    published_at = ma.auto_field()
    
    # Used for hyperlinks associated with resource
    url = ma.Hyperlinks(
        {
...
newsletter_schema = NewsletterSchema() # Used to serialize individual "Newsletter"
newsletters_schema = NewsletterSchema(many=True)  # Used for serialize a collection "Newsletter"
